...
//for...of
//
var someTuple = [1, "string", false]; //someTuple是一个元组，
for (var _i = 0, someTuple_1 = someTuple; _i < someTuple_1.length; _i++) {
    var entry = someTuple_1[_i];
    console.log(entry); //  1, "string", false
}
//forEach
//
var listA = [1, 2, 3];
listA.forEach(function (val, idx, array) {
    // val: 当前值
    // idx：当前index
    // array: Array
...
//
var listB = [4, 5, 6];
listB.every(function (val, idx, array) {
    // val: 当前值
    // idx：当前index
    // array: Array
    console.log(val, idx, array);
